...
fmt: ## format sources (testdata excluded)
	gofumpt -w main.go constraintname functypedup methodpartition testorder topdecl
	goimports -local github.com/CMGS/asl -w main.go constraintname functypedup methodpartition testorder topdecl
